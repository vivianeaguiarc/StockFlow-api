...
export const swaggerComponents = {
  ...
  schemas: {
    ...
    Company: {
      ...
      required: ['id', 'name', 'email', 'active', 'createdAt', 'updatedAt'],
    },
    ...
    StockDashboardResponse: {
      ...
      properties: {
        ...
        activeProducts: { type: 'integer', example: 90 },
        inactiveProducts: { type: 'integer', example: 10 },
        lowStockProducts: { type: 'integer', example: 8 },
        totalStockQuantity: { type: 'integer', example: 1250 },
        totalInventoryValue: { type: 'number', example: 45890.5 },
        recentMovements: {
          type: 'array',
          items: { $ref: '#/components/schemas/RecentStockMovement' },
        },
      },
      required: [
        'totalProducts',
